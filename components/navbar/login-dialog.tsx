...
//     const { user, login, checkAuth, loginExistingUser } = useAuth();
...
//                     password: userWallet,
//                     publicKey: userWallet && !publicKey ? userWallet : publicKey
//                 }),
//               });
...
//                 email: formData.email,
//                 publicKey: userWallet && !publicKey ? userWallet : publicKey!.toBase58(),
//               });
...
//             const newData = {
//                 ...prevData,
//                 [name]: name === 'acceptTerms' ? Date.now() : value
//             };
...
//     useEffect(() => {
//         if(publicKey && slide === 2){
//             setSlide(3);
//         }
//         if(userWallet && slide === 2){
//             setSlide(3);
//         }
//     }, [slide, formData, userWallet, publicKey]);
...
//                         <Button onClick={() => handleRegisterUser} className='rounded-full hover:bg-secondary hover:text-primary'>Continue</Button>
//                     </form>
//                 </CardContent>
//             </Card>      
...
//                             <Checkbox name='acceptTerms' onChange={handleInputChange} />
